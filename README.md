...
Rodar o endpoint "Run Abilities", para fazer o vinculo dos módulos, as ações dos módulos e as habilidades das ações dentro dos módulos.

Para criar um primeiro usuário que não seja superadmin (ID = 1), deve:

Criar o grupo de usuario (Exemplo Admin), usando o endpoint "User Group Create".
Fazer o vinculo das habilidades de módulos a este grupo,  usando o endpoint "User Ability Create". Caso queira ver as habilidades, pode ser verificado
utilizando o endpoint "Ability List", para consultar o id.
Registrar o usuário, usando o endpoint "Register";
