...
use App\Models\ModuleActionPermission;

class ModuleActionPermissionRepository implements ModuleActionPermissionRepositoryInterface
{
    protected $entity;

    public function __construct(ModuleActionPermission $moduleActionPermission)
    {
        $this->entity = $moduleActionPermission;
    }
